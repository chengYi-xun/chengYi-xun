...
>
> ⬅️ 上一篇：[笔记｜生成模型（十六）：强化学习基础与策略梯度](/chengYi-xun/posts/51-rl-basics/)
>
> ➡️ 下一篇：[笔记｜生成模型（十八）：大模型对齐的另一条路：DPO (Direct Preference Optimization)](/chengYi-xun/posts/53-dpo/)
...
> 下一篇：[笔记｜生成模型（十八）：大模型对齐的另一条路：DPO (Direct Preference Optimization)](/chengYi-xun/posts/53-dpo/)

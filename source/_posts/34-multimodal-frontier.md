...
2. **计算最优切分**：根据图像宽高比，选择 $n \in \{1, 2, \ldots, 12\}$ 个 448×448 的子图（tile）
...
3. **测试时计算缩放（Test-Time Scaling）**：推理时让模型生成多个候选答案，取最佳——带来 +3.7% 的 MMMU 提升
...
Qwen2.5-VL（2025 年 3 月发布）的特点不在于刷高单项 benchmark，而在于**能力的广度**：
...
2. Chen, Z., et al. (2024). *How Far Are We to GPT-4V? Closing the Gap to Commercial Multimodal Models with Open-Source Suites* (InternVL 2.5). arXiv:2412.05271.
3. Bai, J., et al. (2025). *Qwen2.5-VL Technical Report*. arXiv.
